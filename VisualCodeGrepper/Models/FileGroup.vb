...
Public Class FileGroup
    ...
    Private Function SetSeverity(Level As Integer) As String
    ...
    Public Sub AddDetail(Key As Integer, Severity As Integer, IssueTitle As String, Description As String, Optional LineNumber As Integer = 1, Optional CodeLine As String = "")
    ...
    Public Sub DeleteDetail(Key As Integer)
