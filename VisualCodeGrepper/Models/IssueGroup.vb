...
Public Class IssueGroup
    ...
    Public Sub SetSeverity(Level As Integer)
    ...
    Public Sub AddDetail(Key As Integer, Filename As String, Optional LineNumber As Integer = 1, Optional CodeLine As String = "")
